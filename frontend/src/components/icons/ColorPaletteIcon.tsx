export default function ColorPaletteIcon(props: { class?: string }) {
  return (
    <svg
      ...
      height="20"
      viewBox="0 0 512 512"
      class={`inline-block h-5 w-5 stroke-current md:h-6 md:w-6 ${props.class || ''}`}
      fill="none"
      {...props}
    >
      <path
        ...
        stroke-width="32"
      />
      <circle cx="144" cy="208" r="24" fill="currentColor"/>
      <circle cx="152" cy="311" r="24" fill="currentColor"/>
      <circle cx="224" cy="144" r="24" fill="currentColor"/>
      <circle cx="328" cy="144" r="24" fill="currentColor"/>
